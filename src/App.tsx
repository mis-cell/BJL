    ...
    await supabase.rpc("exec_sql", { 
      query: `
        ...
        BEGIN 
          ...
          -- Add all inspection master fields across tables
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS mr_date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS arrival_no TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS arrival_date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS po_no TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS po_date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS broker_name TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS supplier_name TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS actual_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS claim_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS actual_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS claim_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS actual_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS claim_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS detention_days NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS unloading_date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS mill_po_no TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS mill_po_date DATE;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS mr_spcl_print TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS remarks TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS lorry_number TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS delivery_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS deduction_type TEXT;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS deduction_rate NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS deduction_qty NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS deduction_amount NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS deduction_types JSONB;
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'Completed';
          ...
          ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS details JSONB;

          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS mr_date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS arrival_no TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS arrival_date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS po_no TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS po_date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS broker_name TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS supplier_name TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS actual_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS claim_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS actual_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS claim_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS actual_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS claim_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS detention_days NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS unloading_date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS mill_po_no TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS mill_po_date DATE;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS mr_spcl_print TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS remarks TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS lorry_number TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS delivery_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS deduction_type TEXT;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS deduction_rate NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS deduction_qty NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS deduction_amount NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS deduction_types JSONB;
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'Completed';
          ...
          ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS details JSONB;

          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS mr_date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS arrival_no TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS arrival_date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS po_no TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS po_date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS broker_name TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS supplier_name TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS actual_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS claim_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS actual_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS claim_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS actual_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS claim_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS detention_days NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS unloading_date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS mill_po_no TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS mill_po_date DATE;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS mr_spcl_print TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS remarks TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS lorry_number TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS delivery_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS deduction_type TEXT;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS deduction_rate NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS deduction_qty NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS deduction_amount NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS deduction_types JSONB;
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS status TEXT DEFAULT 'Completed';
          ...
          ALTER TABLE IF EXISTS inspection_checklist ADD COLUMN IF NOT EXISTS details JSONB;
          ...
          -- Add all detail fields across all inspection detail tables
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS arrival_grade TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS stock_grade_code TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS stock_grade_name TEXT;
          ...
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS crop_year TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lot TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS quantity NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'BALES';
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS challan_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS receipt_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS gross_weight_batch NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS add_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS less_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS reduced_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lorry_moisture_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lorry_moisture_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lorry_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lorry_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS lorry_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS insp_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS insp_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS insp_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS moisture_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS moisture_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS dust_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS dust_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS ncv_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS ncv_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS grade_down_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS grade_down_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS final_receipt_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS settlement_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS settlement_grade_down NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS settlement_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS settlement_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS ropes_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS ropes_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS ropes_grade TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS chotta_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS chotta_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS chotta_grade TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS tolerable TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS row_remarks TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS jqi_remarks TEXT;
          ALTER TABLE IF EXISTS inspection_details ADD COLUMN IF NOT EXISTS jci_remarks TEXT;

          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS arrival_grade TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS stock_grade_code TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS stock_grade_name TEXT;
          ...
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS crop_year TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lot TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS quantity NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'BALES';
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS challan_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS receipt_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS gross_weight_batch NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS add_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS less_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS reduced_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lorry_moisture_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lorry_moisture_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lorry_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lorry_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS lorry_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS insp_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS insp_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS insp_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS moisture_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS moisture_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS dust_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS dust_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS ncv_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS ncv_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS grade_down_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS grade_down_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS final_receipt_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS settlement_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS settlement_grade_down NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS settlement_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS settlement_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS ropes_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS ropes_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS ropes_grade TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS chotta_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS chotta_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS chotta_grade TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS tolerable TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS row_remarks TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS jqi_remarks TEXT;
          ALTER TABLE IF EXISTS mill_inspection_detail ADD COLUMN IF NOT EXISTS jci_remarks TEXT;

          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS arrival_grade TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS stock_grade_code TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS stock_grade_name TEXT;
          ...
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS crop_year TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lot TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS quantity NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'BALES';
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS challan_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS receipt_gross_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS gross_weight_batch NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS add_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS less_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS reduced_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lorry_moisture_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lorry_moisture_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lorry_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lorry_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS lorry_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS insp_read_min NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS insp_read_max NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS insp_read_avg NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS moisture_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS moisture_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS dust_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS dust_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS ncv_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS ncv_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS grade_down_act NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS grade_down_claim NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS final_receipt_wt NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS settlement_moisture NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS settlement_grade_down NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS settlement_dust NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS settlement_ncv NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS ropes_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS ropes_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS ropes_grade TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS chotta_weight NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS chotta_tot_wt_grd NUMERIC DEFAULT 0;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS chotta_grade TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS tolerable TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS row_remarks TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS jqi_remarks TEXT;
          ALTER TABLE IF EXISTS inspection_checklist_details ADD COLUMN IF NOT EXISTS jci_remarks TEXT;
