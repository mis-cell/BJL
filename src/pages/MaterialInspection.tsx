...
export default function MaterialInspection({
 ...
 id="mr_spcl_print_3334" aria-label="Way Bill No."                    type="text"
                ...
                {/* Weights Details Table Matrix (Screenshot 1 breakdown) */}
 ...
 id="quantity_3844" name="quantity" aria-label="Quantity"                            type="number"
                        ...
                        <div className="flex items-center gap-2">
                          <label htmlFor="final_wt_m_ton_3858" className="w-28 font-semibold text-slate-600">Challan Gross Wt. MT.</label>
                          <input
 id="final_wt_m_ton_3858" name="final_wt_m_ton" aria-label="Challan Gross Wt. MT."                            type="number"
                            step="0.001"
                ...
                <table className="w-full border-collapse text-xs">
                  ...
                  <tbody className="divide-y divide-slate-200 font-semibold text-slate-800">
                    ...
                    <tr className="hover:bg-blue-50/50">
                      ...
                      {['1st', '2nd', '3rd', '4th'].map((col, idx) => (
                        <React.Fragment key={idx}>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_grade_down_dept_${idx}`} name="qualitymatrix_grade_down_dept" aria-label="qualitymatrix grade down dept"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.grade_down?.[col]?.dept ?? detailsList[idx]?.actual_grade_down ?? (idx === 0 ? masterData.actual_grade_down : '')} onChange={(e) => { updateMatrixVal('grade_down', col, 'dept', e.target.value); handleDetailChange(idx, 'actual_grade_down', e.target.value); if(idx===0) setMasterData(m => ({...m, actual_grade_down: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold disabled:bg-slate-100" /></td>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_grade_down_claim_${idx}`} name="qualitymatrix_grade_down_claim" aria-label="qualitymatrix grade down claim"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.grade_down?.[col]?.claim ?? detailsList[idx]?.claim_grade_down ?? (idx === 0 ? masterData.claim_grade_down : '')} onChange={(e) => { updateMatrixVal('grade_down', col, 'claim', e.target.value); handleDetailChange(idx, 'claim_grade_down', e.target.value); if(idx===0) setMasterData(m => ({...m, claim_grade_down: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-amber-700 bg-amber-50/40 disabled:bg-slate-100" /></td>
                          <td className={`p-1 ${idx < 3 ? 'border-r border-slate-300' : ''}`}><input  id={`qualitymatrix_grade_down_sett_${idx}`} name="qualitymatrix_grade_down_sett" aria-label="qualitymatrix grade down sett"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.grade_down?.[col]?.sett || ''} onChange={(e) => updateMatrixVal('grade_down', col, 'sett', e.target.value)} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-emerald-800 disabled:bg-slate-100" /></td>
                        </React.Fragment>
                      ))}
                    </tr>
                    ...
                    <tr className="hover:bg-blue-50/50">
                      ...
                      {['1st', '2nd', '3rd', '4th'].map((col, idx) => (
                        <React.Fragment key={idx}>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_moisture_dept_${idx}`} name="qualitymatrix_moisture_dept" aria-label="qualitymatrix moisture dept"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moisture?.[col]?.dept ?? detailsList[idx]?.actual_moisture ?? (idx === 0 ? masterData.actual_moisture : '')} onChange={(e) => { updateMatrixVal('moisture', col, 'dept', e.target.value); handleDetailChange(idx, 'actual_moisture', e.target.value); if(idx===0) setMasterData(m => ({...m, actual_moisture: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold disabled:bg-slate-100" /></td>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_moisture_claim_${idx}`} name="qualitymatrix_moisture_claim" aria-label="qualitymatrix moisture claim"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moisture?.[col]?.claim ?? detailsList[idx]?.claim_moisture ?? (idx === 0 ? masterData.claim_moisture : '')} onChange={(e) => { updateMatrixVal('moisture', col, 'claim', e.target.value); handleDetailChange(idx, 'claim_moisture', e.target.value); if(idx===0) setMasterData(m => ({...m, claim_moisture: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-amber-700 bg-amber-50/40 disabled:bg-slate-100" /></td>
                          <td className={`p-1 ${idx < 3 ? 'border-r border-slate-300' : ''}`}><input  id={`qualitymatrix_moisture_sett_${idx}`} name="qualitymatrix_moisture_sett" aria-label="qualitymatrix moisture sett"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moisture?.[col]?.sett || ''} onChange={(e) => updateMatrixVal('moisture', col, 'sett', e.target.value)} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-emerald-800 disabled:bg-slate-100" /></td>
                        </React.Fragment>
                      ))}
                    </tr>
                    ...
                    <tr className="hover:bg-blue-50/50">
                      ...
                      {['1st', '2nd', '3rd', '4th'].map((col, idx) => (
                        <React.Fragment key={idx}>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_dust_dept_${idx}`} name="qualitymatrix_dust_dept" aria-label="qualitymatrix dust dept"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.dust?.[col]?.dept ?? detailsList[idx]?.actual_dust ?? (idx === 0 ? masterData.actual_dust : '')} onChange={(e) => { updateMatrixVal('dust', col, 'dept', e.target.value); handleDetailChange(idx, 'actual_dust', e.target.value); if(idx===0) setMasterData(m => ({...m, actual_dust: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold disabled:bg-slate-100" /></td>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_dust_claim_${idx}`} name="qualitymatrix_dust_claim" aria-label="qualitymatrix dust claim"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.dust?.[col]?.claim ?? detailsList[idx]?.claim_dust ?? (idx === 0 ? masterData.claim_dust : '')} onChange={(e) => { updateMatrixVal('dust', col, 'claim', e.target.value); handleDetailChange(idx, 'claim_dust', e.target.value); if(idx===0) setMasterData(m => ({...m, claim_dust: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-amber-700 bg-amber-50/40 disabled:bg-slate-100" /></td>
                          <td className={`p-1 ${idx < 3 ? 'border-r border-slate-300' : ''}`}><input  id={`qualitymatrix_dust_sett_${idx}`} name="qualitymatrix_dust_sett" aria-label="qualitymatrix dust sett"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.dust?.[col]?.sett || ''} onChange={(e) => updateMatrixVal('dust', col, 'sett', e.target.value)} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-emerald-800 disabled:bg-slate-100" /></td>
                        </React.Fragment>
                      ))}
                    </tr>
                    ...
                    <tr className="hover:bg-blue-50/50">
                      ...
                      {['1st', '2nd', '3rd', '4th'].map((col, idx) => (
                        <React.Fragment key={idx}>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_ncv_dept_${idx}`} name="qualitymatrix_ncv_dept" aria-label="qualitymatrix ncv dept"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moc?.[col]?.dept ?? detailsList[idx]?.actual_ncv ?? (idx === 0 ? masterData.actual_ncv : '')} onChange={(e) => { updateMatrixVal('moc', col, 'dept', e.target.value); handleDetailChange(idx, 'actual_ncv', e.target.value); if(idx===0) setMasterData(m => ({...m, actual_ncv: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold disabled:bg-slate-100" /></td>
                          <td className="p-1 border-r border-slate-200"><input  id={`qualitymatrix_ncv_claim_${idx}`} name="qualitymatrix_ncv_claim" aria-label="qualitymatrix ncv claim"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moc?.[col]?.claim ?? detailsList[idx]?.claim_ncv ?? (idx === 0 ? masterData.claim_ncv : '')} onChange={(e) => { updateMatrixVal('moc', col, 'claim', e.target.value); handleDetailChange(idx, 'claim_ncv', e.target.value); if(idx===0) setMasterData(m => ({...m, claim_ncv: Number(e.target.value)})); }} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-amber-700 bg-amber-50/40 disabled:bg-slate-100" /></td>
                          <td className={`p-1 ${idx < 3 ? 'border-r border-slate-300' : ''}`}><input  id={`qualitymatrix_ncv_sett_${idx}`} name="qualitymatrix_ncv_sett" aria-label="qualitymatrix ncv sett"type="number" step="0.1" disabled={!isEditMode} value={qualityMatrix.moc?.[col]?.sett || ''} onChange={(e) => updateMatrixVal('moc', col, 'sett', e.target.value)} className="w-full h-7 rounded border border-slate-200 text-center font-bold text-emerald-800 disabled:bg-slate-100" /></td>
                        </React.Fragment>
                      ))}
                    </tr>
