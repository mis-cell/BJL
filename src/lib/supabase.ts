...
if (supabase) {
  Promise.resolve().then(async () => {
    ...
    const schemaQueries = [
      ...
      `ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS unit_code TEXT;`,
      `ALTER TABLE IF EXISTS mill_inspection_master ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'BALES';`,
      ...
      `ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS unit_name TEXT DEFAULT 'BALES';`,
      `ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS unit_code TEXT;`,
      `ALTER TABLE IF EXISTS inspection_master ADD COLUMN IF NOT EXISTS unit TEXT DEFAULT 'BALES';`,
