...
if (supabase) {
  Promise.resolve().then(async () => {
    ...
    const schemaQueries = [
      ...
      `ALTER TABLE IF EXISTS sauda_check_point_details ADD COLUMN IF NOT EXISTS grade_name TEXT;`,
      `ALTER TABLE IF EXISTS sauda_check_point_details ADD COLUMN IF NOT EXISTS agency_name TEXT;`,
      `ALTER TABLE IF EXISTS sauda_check_point_details ADD COLUMN IF NOT EXISTS marka_name TEXT;`,
      `ALTER TABLE IF EXISTS sauda_check_point_details ADD COLUMN IF NOT EXISTS premium NUMERIC(15,2) DEFAULT 0;`,
      `ALTER TABLE IF EXISTS purchase_detail_master ADD COLUMN IF NOT EXISTS grade_name TEXT;`,
      `ALTER TABLE IF EXISTS purchase_detail_master ADD COLUMN IF NOT EXISTS agency_name TEXT;`,
      `ALTER TABLE IF EXISTS purchase_detail_master ADD COLUMN IF NOT EXISTS marka_name TEXT;`,
